...
class SmartUI extends SmartUtil {
    ...
    public static function print_alert($message, $type = 'info', $options = array(), $return = false) {
    	...
    	$result = '<div class="alert round bg-'.$type.' alert-icon-left alert-arrow-left alert-dismissible mb-2" role="alert">
                      <span class="alert-icon"><i class="la la-'.$icon_map[$type].'"></i></span>
