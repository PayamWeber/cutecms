                ...
                <article class="col-sm-12 col-md-5 sortable-grid ui-sortable">
                    <div class="col-12">
                        <div class="card profile-with-cover">
                            <div class="card-img-top img-fluid bg-cover height-300" style="background: url('{{ admin_assets_url() }}/app-assets/images/carousel/22.jpg') 50%;"></div>
                            <div class="media profil-cover-details w-100">
                                <div class="media-left pl-2 pt-2">
                                    <a href="#" class="profile-image">
                                        <img src="{{ admin_assets_url() }}/app-assets/images/portrait/small/avatar-s-8.png"
                                        ...
                                        <div class="col text-right">
                                            <div id='avatar_upload' class='media-upload-buttons' data-upload-type='avatar'>
                                                <div class="btn-group d-none d-md-block float-right ml-2 this-buttons" role="group" aria-label="Basic example">
                                                    <button type="button" class="btn btn-danger delete-current-media hidden">
