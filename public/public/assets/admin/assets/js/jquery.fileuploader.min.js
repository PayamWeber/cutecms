...
!function ( e ) {
    ...
    a.fileapi = void 0 !== e( "<input type='file'/>" ).get( 0 ).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function ( t ) {
        ...
        {
            var t, r, o = [],
                s = (o = "string" == jQuery.type( a ) ? a.split( "&" ) : e.param( a ).split( "&" )).length, i = [];
        ...
        function l( a, t, r )
        {
            for ( var o = 0; o < r.length; o++ ) if ( n( t, a, r[ o ].name ) ) if ( a.allowDuplicates || !d( t, r[ o ].name ) ) if ( -1 != a.maxFileSize && r[ o ].size > a.maxFileSize ) a.showError && e( "<div class='" + a.errorClass + "'><b>" + r[ o ].name + "</b> " + a.sizeErrorStr + s( a.maxFileSize ) + "</div>" ).appendTo( t.errorLog ); else if ( -1 != a.maxFileCount && t.selectedFiles >= a.maxFileCount ) a.showError && e( "<div class='" + a.errorClass + "'><b>" + r[ o ].name + "</b> " + a.maxFileCountErrorStr + a.maxFileCount + "</div>" ).appendTo( t.errorLog ); else
            {
                ...
                var l = e.extend( {}, a ), u = new FormData, p = a.fileName.replace( "[]", "" );
                u.append( p, r[ o ] );
                var c = a.formData;
                if ( c ) for ( var h = i( c ), f = 0; f < h.length; f++ ) h[ f ] && u.append( h[ f ][ 0 ], h[ f ][ 1 ] );
                l.fileData = u;
                var w = new m( t, a ), g = "";
                g = a.showFileCounter ? r[ o ].name : r[ o ].name, a.showFileSize && (g += " <span class='ajax-file-upload-filename-size'>(" + s( r[ o ].size ) + ")</span>"), w.filename.html( g );
        ...
        function p( e, a )
        {
            if ( e )
            {
                ...
                t.onload = function ( e ) {
                    a.attr( "style", "background-image:url(" + e.target.result + ")" );
                }, t.readAsDataURL( e );
            }
        }
        ...
        function c( a, t )
        {
            if ( a.showFileCounter )
            {
                ...
                t.fileCounter = r + 1, e( t.container ).find( ".ajax-file-upload-filename" ).each( function ( t, o ) {
                    var s = e( this ).html().split( a.fileCounterStyle ), i = (parseInt( s[ 0 ] ), s[ 1 ]);
                    e( this ).html( i ), r--;
                } );
            }
        }
        ...
        function f( a, t )
        {
            return this.statusbar = e( "<div class='ajax-file-upload-statusbar'></div>" ).width( t.statusBarWidth ), this.preview = e( "<div class='ajax-file-upload-preview' ></div>" ).appendTo( this.statusbar ).hide(), this.filename = e( "<div class='ajax-file-upload-filename'></div>" ).appendTo( this.statusbar ), this.progressDiv = e( "<div class='ajax-file-upload-progress'>" ).appendTo( this.statusbar ).hide(), this.progressbar = e( "<div class='ajax-file-upload-bar'></div>" ).appendTo( this.progressDiv ), this.abort = e( "<div>" + t.abortStr + "</div>" ).appendTo( this.statusbar ).hide(), this.cancel = e( "<div>" + t.cancelStr + "</div>" ).appendTo( this.statusbar ).hide(), this.done = e( "<div>" + t.doneStr + "</div>" ).appendTo( this.statusbar ).hide(), this.download = e( "<div>" + t.downloadStr + "</div>" ).appendTo( this.statusbar ).hide(), this.del = e( "<div>" + t.deleteStr + "</div>" ).appendTo( this.statusbar ).hide(), this.abort.addClass( "ajax-file-upload-red" ), this.done.addClass( "ajax-file-upload-green" ), this.download.addClass( "ajax-file-upload-green" ), this.cancel.addClass( "ajax-file-upload-red" ), this.del.addClass( "ajax-file-upload-red" ), this;
        }
        ...
        function v( t, o, s, l, n, d )
        {
            var h = {
                ...
                beforeSend: function ( e, t ) {
                    // console.log( s.filename.text().replace( /^(.*) \(.*\)$/, "$1" ) );
                    var _file_name = s.filename.text().replace( /^(.*) \(.*\)$/, "$1" );
                    s.statusbar.attr( 'data-file-name', _file_name );
                ...
                success: function ( a, r, i ) {
                    ...
                    {
                        s.abort.hide();
                        return o.onError.call( this, l, 200, d, s ), o.showStatusAfterError ? (s.progressDiv.hide(), s.statusbar.append( "<span class='" + o.errorClass + "'>خطا: " + a.result[ _file_name ].text + "</span>" )) : (s.statusbar.hide(), s.statusbar.remove()), n.selectedFiles -= l.length, void t.remove();
                    }
                    if ( a.type == 'success' )
                    {
                        s.statusbar.attr( 'data-file-id', a.result[ _file_name ].id );
                        s.statusbar.attr( 'data-caption', a.result[ _file_name ].name );
                        s.statusbar.attr( 'title', a.result[ _file_name ].name );
                        for ( var this_key in a.result[ _file_name ].urls )
                        {
                            s.statusbar.attr( 'data-' + this_key, a.result[ _file_name ].urls[ this_key ] );
                        }
                        s.statusbar.find( '.ajax-file-upload-red:contains("حذف")' ).html( '<i class=\'la la-close\'></i>' );
                        $( '<div style="" class="ajax-file-upload-blue ajax-file-upload-select">انتخاب</div>' ).insertAfter( s.statusbar.find( '.ajax-file-upload-red:contains("حذف")' ) );
                    }
                    ...
                    if ( s.cancel.remove(), F.pop(), "json" == o.returnType && "object" == e.type( a ) && a.hasOwnProperty( o.customErrorKeyStr ) )
                    {
                        ...
                        return o.onError.call( this, l, 200, d, s ), o.showStatusAfterError ? (s.progressDiv.hide(), s.statusbar.append( "<span class='" + o.errorClass + "'>خطا: " + d + "</span>" )) : (s.statusbar.hide(), s.statusbar.remove()), n.selectedFiles -= l.length, void t.remove();
                    }
                    n.responses.push( a ), s.progressbar.width( "100%" ), o.showProgress && (s.progressbar.html( "100%" ), s.progressbar.css( "text-align", "center" )), s.abort.hide(), o.onSuccess.call( this, l, a, i, s ), o.showStatusAfterSuccess ? (o.showDone ? (s.done.show(), s.done.click( function () {
                        ...
                        setTimeout( function () {
                            // s.statusbar.remove();
                        }, 300 ), o.deleteCallback && o.deleteCallback.call( this, a, s ), n.selectedFiles -= l.length, c( o, n );
                ...
                error: function ( e, a, r ) {
                    s.cancel.remove(), F.pop(), s.abort.hide(), "abort" == e.statusText ? (s.statusbar.hide( "slow" ).remove(), c( o, n )) : (o.onError.call( this, l, a, r, s ), o.showStatusAfterError ? (s.progressDiv.hide(), s.statusbar.append( "<span class='" + o.errorClass + "'>خطا: " + r + "</span>" )) : (s.statusbar.hide(), s.statusbar.remove()), n.selectedFiles -= l.length), t.remove();
                }
            };
        ...
        var w = e.extend( {
            ...
            dragDropStr: "<span><b>" + lang.drop_files_here + "</b></span>",
            uploadStr: lang.upload,
            abortStr: lang.abort_upload,
            cancelStr: lang.cancel,
            deleteStr: lang.delete,
            doneStr: lang.done,
            multiDragErrorStr: "متاسفانه امکان رها کردن چندین فایل همزمان وجود ندارد. لطفا به صورت تک تک آپلود نمایید.",
            extErrorStr: "<br> " + lang.file_format_is_not_valid + ". " + lang.allowed_formats + ": ",
            duplicateErrorStr: "is not allowed. File already exists.",
            sizeErrorStr: "<br> " + lang.file_size_is_not_valid + ". " + lang.max_allowed_size + ": ",
        ...
        e( b ).addClass( w.uploadButtonClass ), function a() {
            ...
            var o = "";
            return o = w.showFileCounter ? C.fileCounter + w.fileCounterStyle + e : e, w.showFileSize && (o += " (" + s( t ) + ")"), r.filename.html( o ), C.fileCounter++, C.selectedFiles++, w.showPreview && (r.preview.attr( "style", "background-image:url(" + a + ")" ), r.preview.show()), w.showDownload && (r.download.show(), r.download.click( function () {
